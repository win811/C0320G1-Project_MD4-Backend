...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/api/v1/login","/api/v1/recover/**","/api/v1/user/register","/api/v1/home/**","/api/v1/productPromotions/**",
                                                 "/api/v1/user/checkEmail", "/api/v1/user/checkPhone").permitAll()
                .and()
                .authorizeRequests().antMatchers("/api/v1/cart/**","/api/v1/user/**","/api/v1/myProduct/**","/api/v1/myAuctionRecords/**", "/api/v1/payment/**","/api/v1/products/**",
